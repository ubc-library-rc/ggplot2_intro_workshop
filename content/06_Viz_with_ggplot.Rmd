...
#To get one regression line per species, move the grouping into aes() such as:
...
Using the countries dataset, plot gdpPercap (gdp per capita, x variable) vs lifeExp (life expectancy, y variable). Add a linear trend line to the plot.
